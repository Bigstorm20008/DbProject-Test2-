...
EditControlTemplate::EditControlTemplate(HWND parent, int editXPos, int editYPos, int editWidth, int editHeight, UINT editStyle)
{
	createEditControl(parent, editXPos, editYPos, editWidth, editHeight, editStyle);
